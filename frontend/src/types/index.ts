...
export interface ProgressItem {
  ...
  updatedAt?: number;
  /** Which of the 4 phases this step belongs to (for grouped display) */
  phase?: BuilderPhase;
}
...
export interface WebSocketMessage {
  ...
  // runtime_target_updated: false when the conversation had already started
  accepted?: boolean;
