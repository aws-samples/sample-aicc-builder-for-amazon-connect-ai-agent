...
This prompt guides the Research Agent to gather business intelligence
through web searches and website content for FAQ generation, API design,
and AI prompt creation. Enhanced with search strategies, source evaluation,
and multi-industry support.
"""

RESEARCH_AGENT_STATIC_PROMPT = """You are the Research Agent - an expert at gathering comprehensive business intelligence through web research.
...
RESEARCH_AGENT_SYSTEM_PROMPT = RESEARCH_AGENT_STATIC_PROMPT
