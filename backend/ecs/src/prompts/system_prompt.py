"""
System prompt for the AICC Builder Orchestrator Agent.

This agent:
1. Directly interviews users to gather requirements (no separate interviewer agent)
2. Coordinates generation Sub-Agents to produce artifacts
3. Presents everything as a unified assistant experience

Phase-based prompt splitting:
- COMMON_PROMPT: Role, PM mindset, Rules 1-4, User Guidance (always loaded)
- INTERVIEW_PROMPT: Rules 5-9, Phase A/A-2/A.5/C, sub-agent triggers
- GENERATION_PROMPT: Generation flow, 5-phase, modifications, progress
- REVIEW_PROMPT: Reviewer, change impact, regeneration
- TOOLS_REFERENCE: Available tools documentation
- SCHEMA_REFERENCE: Schema propagation, consistency rules
- TERMINOLOGY_FACTS: Authoritative Amazon Connect AI Agent terminology (overrides training)
...
# =============================================================================
COMMON_PROMPT = """You are the AICC Builder - an AI assistant that helps customers build AI-powered contact center solutions.
...
# =============================================================================
# TERMINOLOGY_FACTS — Authoritative product names & architecture (override training)
# This block is loaded in EVERY phase and EVERY sub-agent. Keep it short and
# verified. Do not add claims that aren't backed by primary AWS docs.
# =============================================================================
TERMINOLOGY_FACTS = """
...
# =============================================================================
# GENERATION_PROMPT — Generation flow, 5-phase workflow, modifications, progress
# =============================================================================
GENERATION_PROMPT = """
...
# =============================================================================
# SCHEMA_REFERENCE — Schema propagation, consistency rules, examples
# =============================================================================
SCHEMA_REFERENCE = """
...
# =============================================================================
# REGENERATION_PROMPT — Targeted fixes after review
# =============================================================================
REGENERATION_PROMPT = """
...
SYSTEM_PROMPT = "\n\n".join([
    COMMON_PROMPT, TERMINOLOGY_FACTS, INTERVIEW_PROMPT, GENERATION_PROMPT, REVIEW_PROMPT,
    REGENERATION_PROMPT, TOOLS_REFERENCE, SCHEMA_REFERENCE, CONNECT_GUIDE,
])
...
DOCUMENT_ANALYSIS_PROMPT = """You are the AICC Builder Agent running in DOCUMENT ANALYSIS MODE.
...
def get_document_analysis_prompt(document_content: str) -> str:
    """Generate the system prompt for document analysis mode.

    The Agent will directly read and understand the raw document,
    regardless of format (markdown, plain text, tables, etc.)
    """
